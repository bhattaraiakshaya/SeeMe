...
CHROME_DRIVER_PATH = CHROME_DRIVER_EXECUTABLE_PATH
# CHROME_DRIVER_PATH = config('CHROME_DRIVER_EXECUTABLE_PATH')


# gets list of proxies from sslproxies.org
def get_proxies():
...
def get_driver(proxies, load_images=False, disk_cache=True):
    options = webdriver.ChromeOptions()

    # assign random proxy server
